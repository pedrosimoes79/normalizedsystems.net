...
namespace NormalizedSystems.Net.Designers
{
    ...
    {
        #region Fields
        private VSPackage _thisPackage;
        private string _fileName = string.Empty;
        private NormalizedSystemsDesigner _vsDesignerControl;
        ...
        public EditorPane(VSPackage package, string fileName, IVsTextLines textBuffer)
            : base(null)
        {
        ...
        protected override void Initialize()
        {
            ...
            _vsDesignerControl = new NormalizedSystemsDesigner(new ViewModel(_store, _model, this, _textBuffer));
        ...
        {
            pGuidCmdId = Guids.GuidNormalizedSystemsDesignerEditorFactory;

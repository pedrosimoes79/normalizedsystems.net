...
namespace NormalizedSystems.Net.Designers
{
    ...
    {
        public static string ErrorMessageBoxTitle = "NormalizedSystems Designer";
        public static string FieldNameDescription = "Description";
        public static string FieldNameId = "ID";
        public static string InvalidDescriptorData = "Invalid descriptor data ";
    ...
    public class ViewModel : INotifyPropertyChanged
    {
        XmlModel _xmlModel;
        XmlStore _xmlStore;
        Definitions.Application _application;

        public Definitions.Application Application
        {
            get
            {
                return _application;
        ...
        private void LoadModelFromXmlModel()
        {
            try
            {
                ...
                using (var reader = GetParseTree().CreateReader())
                {
                    _application = (Definitions.Application)serializer.Deserialize(reader);

                    _application.PropertyChanged += 
                        (sender, e) => 
                        {
                            RaisePropertyChanged("Application");
                        };
            ...
            catch (Exception e)
            {
                ...
                ErrorHandler.ThrowOnFailure(VsShellUtilities.ShowMessageBox(_serviceProvider,
                    ResourceInfo.InvalidDescriptorData + e.Message,
        ...
        void SaveModelToXmlModel(string undoEntry)
        {
            ...
            try
            {
                ...
                XmlSerializer serializer = new XmlSerializer(typeof(NormalizedSystems.Net.Definitions.Application));
                XDocument documentFromDesignerState = new XDocument();
                using (XmlWriter w = documentFromDesignerState.CreateWriter())
                {
                    serializer.Serialize(w, _application);
                }

...
namespace NormalizedSystems.Net.Designers
{
    ...
    /// </summary>
    [Guid(Guids.GuidNormalizedSystemsDesignerEditorFactoryString)]
    public sealed class EditorFactory : IVsEditorFactory, IDisposable
    {
        public const string Extension = ".nsd";

        private VSPackage editorPackage;
                        ...
                        out int pgrfCDW)
        {
            ...
            pguidCmdUI = Guids.GuidNormalizedSystemsDesignerEditorFactory;
            pgrfCDW = 0;
